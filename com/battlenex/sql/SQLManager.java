...
public class SQLManager {
	...
	public static String WEBSITE_URL = "battle-soul.com";
	...
	public synchronized static void createConnection() {
		try {
			...
			conn =
			DriverManager.getConnection("jdbc:mysql://"+WEBSITE_URL+"/forum", MySQLUser, MySQLPassword);
			Utils.println("MySQL has been connected.");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
