package com.battlenex.game.objects.doors;
...
import com.battlenex.game.objects.Objects;
...
public class DoubleDoors {
	...
	public static DoubleDoors getSingleton() {
		if (singleton == null) {
			singleton = new DoubleDoors("./data/doors/double_doors.txt");
		}
		return singleton;
	}
	...
	public void load() {
		...
		Jarvis.printText("Loaded "+ doors.size() +" Double doors in "+ (System.currentTimeMillis() - start) +"ms.");
	}
