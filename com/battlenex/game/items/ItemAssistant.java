...
public class ItemAssistant {
	...
	**/
	...
	public static String[] HATS = {"top hat","pharaoh bun","pagri","top hat", "cavalier","helmet","sallet", "wreath", "hat", "hat (t)", "hat (g)", "helm","tiara", "mask", "coif", "hood", "headdress", "cowl"};
	public static String[] CAPES = {"tokhaar-kal","apparatus","cape", "accumulator", "attractor", "cloak", "alerter"};
	public static String[] AMULETS = {"holy symbol","scarf","amulet", "necklace"};
	public static String[] WEAPONS = {"hatchet","mega-phonus","zaryte","sabre","flail", "flag", "banner", "hand", "mace", "dart", "knife", "javelin", "scythe", "claws", "bow", "crossbow", "c' bow", "adze", "axe", "sword", "rapier", "scimitar", "spear", "dagger", 
									"staff", "wand", "blade", "whip", "silverlight", "darklight", "maul", "halberd", "anchor", "tzhaar-ket-om", "hammer", "hand cannon"};
	public static String[] BODY = {"tunic","robe (g)", "robe (t)", "hauberk", "torso", "body", "top", "platebody (g)", "platebody (t)", "platebody", "chainbody", "shirt", "chestplate", "guthix dragonhide", 
									"zamorak dragonhide", "saradomin dragonhide", "brassard"};
	public static String[] SHIELDS = {"shield", "sled", "book", "off-hand", "defender", "toktz-ket-xil"};
	public static String[] LEGS = {"leggings", "tights", "cuisse", "chaps", "platelegs", "platelegs (t)", "platelegs (g)", "skirt", "tassets", "bottoms", "bottom", "trousers", "legs", "cuise", "void knight robe"};
	public static String[] GLOVES = {"gloves", "gauntlets", "vambraces", "vamb"};
	public static String[] BOOTS = {"flippers","boots", "shoes"};
	public static String[] RINGS = {"ring"};
	public static String[] ARROWS = {"blouse","bolts", "arrow", "bolt rack", "hand cannon shot arrow"};
...
case 12744:
					if(c.getPA().getLevelForXP(c.playerXP[0]) < 99 && c.getPA().getLevelForXP(c.playerXP[2]) < 99 && c.getPA().getLevelForXP(c.playerXP[1]) < 99 && c.getPA().getLevelForXP(c.playerXP[4]) < 99 && c.getPA().getLevelForXP(c.playerXP[5]) < 99 && c.getPA().getLevelForXP(c.playerXP[6]) < 99 && c.getPA().getLevelForXP(c.playerXP[3]) < 99 && c.getPA().getLevelForXP(c.playerXP[22]) < 99) {
					c.sendMessage("You need all 99 combat skills To wear this Cape.");
					return false;
					}		
					break;
					case 9747:
					...
					break;
					case 12747:
					if(c.getPA().getLevelForXP(c.playerXP[20]) < 99 && c.getPA().getLevelForXP(c.playerXP[16]) < 99 && c.getPA().getLevelForXP(c.playerXP[21]) < 99 && c.getPA().getLevelForXP(c.playerXP[15]) < 99 && c.getPA().getLevelForXP(c.playerXP[17]) < 99 && c.getPA().getLevelForXP(c.playerXP[12]) < 99 && c.getPA().getLevelForXP(c.playerXP[9]) < 99 && c.getPA().getLevelForXP(c.playerXP[14]) < 99 && c.getPA().getLevelForXP(c.playerXP[13]) < 99 && c.getPA().getLevelForXP(c.playerXP[10]) < 99 && c.getPA().getLevelForXP(c.playerXP[7]) < 99 && c.getPA().getLevelForXP(c.playerXP[11]) < 99 && c.getPA().getLevelForXP(c.playerXP[8]) < 99 && c.getPA().getLevelForXP(c.playerXP[19]) < 99) {
					c.sendMessage("You need 99 in all Skilling (farming, woodcutting, etc) To wear this cape");
					return false;
					}
					break;
					case 9767:
					...
					case 12170:
					case 12171:
					if(c.getPA().getLevelForXP(c.playerXP[22]) < 99) {
					c.sendMessage("You need 99 summoning to wear this item.");
					return false;
					}
					break;
					case 9948:
					case 9949:
					case 9950:
					if(c.getPA().getLevelForXP(c.playerXP[21]) < 99) {
					c.sendMessage("You need 99 Hunting to wear this item.");
					return false;
					}
					break;
					case 9774:
	...
	**/
	public void deleteArrow() {
		synchronized(c) {
			if (c.playerEquipment[c.playerCape] == 10499 && Utils.random(5) != 1 && c.playerEquipment[c.playerArrows] != 4740)
				return;
