...
import com.battlenex.game.players.skills.mining.MiningAreas;
	...
	public void processPacket(Client client, int i, int j) {
		...
		case 132:
			...
			if (client.playerRights >= 3
				...
				Utils.println((new StringBuilder()).append("objectId: ")
			...
			if (Math.abs(client.getX() - client.objectX) > 25
				...
				case 1557:
				case 1558:
					c.sendMessage("This gate is locked.");
					break;
