...
public class PlayerSave {
	...
	public static int loadGame(Client p, String playerName, String playerPass) {
		...
		if (File1) {
			...
			Utils.println(playerName + ": character file not found.");
			p.newPlayer = false;
			return 0;
		}
		try {
			...
			Utils.println(playerName + ": error loading file.");
			return 3;
		}
		while (EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					...
					} else if(token.equals("creationDate")) {
							p.creationDate = token2;
	...
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.write("creationDate");
			...
			Utils.println(p.playerName + ": error writing file.");
			return false;
		}
		return true;
	}
