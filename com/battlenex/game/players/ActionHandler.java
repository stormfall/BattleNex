...
import com.battlenex.game.objects.Object;
import com.battlenex.game.settings.Constants;
import com.battlenex.utils.Utils;
import com.battlenex.utils.ScriptManager;
...
public class ActionHandler {
	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		case 6823:
			if (com.battlenex.game.minigames.Barrows.selectCoffin(c, objectType)) {
				return;
			}
	...
	public void thirdClickNpc(int npcType) {
		...
		default:
			...
			if (c.playerRights == 3)
				Utils.println("Third Click NPC : " + npcType);
			break;
