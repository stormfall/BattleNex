...
import com.battlenex.game.dialogues.DialogueContainer;
...
import com.battlenex.utils.ISAACRandomGen;
...
public abstract class Player {
	...
	saveDelay, playerKilled, pkPoints, totalPlayerDamageDealt, killedBy,
			...
			pcPoints = 0, triviaPoints = 0, magePoints = 0, desertTreasure = 0,
	...
	public int specMaxHitIncrease, freezeDelay, freezeTimer = -6, killerId,
			...
			crystalBowArrowCount, playerMagicBook, teleGfx, teleEndGfx, teleEndAnimation,
	...
	public int apset;
	public int actionID;
	public int wearItemTimer, wearId, wearSlot;
	...
	public static boolean appearanceUpdateRequired = true;
	...
	protected void appendPlayerAppearance(Stream str) {
		...
		playerProps.writeQWord(Utils.playerNameToInt64(playerName));
	...
	public void postProcessing() {
		if (this.newWalkCmdSteps > 0) {
			...
			int dir = Utils.direction(this.currentX, this.currentY, firstX,
					firstY);
			if (dir != -1 && (dir & 1) != 0) {
				do {
					int var13 = dir;
					...
					dir = Utils.direction(this.walkingQueueX[ptr],
			...
			if (found) {
				...
				if (dir != -1 && (dir & 1) != 0) {
					...
					dir = Utils.direction(wayPointX1, wayPointY1, i, wayPointY2);
					if (dir != -1 && (dir & 1) == 0) {
						dir >>= 1;
						found = false;
						int x = wayPointX1;
	...
	public boolean blockAnim = false;
