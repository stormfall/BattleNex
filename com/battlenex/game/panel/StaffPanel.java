package com.battlenex.game.panel;
...
public class StaffPanel extends JFrame {
	...
	public StaffPanel(boolean visible) {
	...
	public void initComponents() {
		setTitle(Constants.SERVER_NAME + " Developer & Staff Control Panel");
		if (!PANEL_ACTIVE) {
			System.out.println("Control panel has started.");
			return;
		}
		...
		MESSAGE_ALL_BOX.setModel(new DefaultComboBoxModel(new String[] { "Alert", "Paid", "Event", "Vote", "Update", "Server", "BattleNex", "Staff", "Yell", "News", "Minigames", "Clanwars", "Soulwars", "Dungeoneering", "Quest", "BS", "Forums", "RuneLocus", "Rune-Server", "Ad", "Control Panel","Panel", "Console", "Prompt", "None" }));
		...
		IPBAN_PLAYER.setText("Ban IP");
		IPBAN_PLAYER.setToolTipText("Ban a players ip from ever connecting.");
		...
		IPMUTE_PLAYER.setText("Mute IP");
		IPMUTE_PLAYER.setToolTipText("Mute a players ip so that any same connection cannot speak.");
		...
		FORCE_NPC.setText("Switch to NPC");
		...
		EMPTY_INVENTORY.setText("Empty Inventory");
		...
		FORCE_NPCS_CHAT_TEXT.setText("Hello...");
		...
		UPDATE_SETTINGS.setText("Apply Changes");
	...
	private Image getImage(String name) {
		String url = "http://battle-soul.com/game/data/" + name;
		try {
			File f = new File("./data/panel/" + name);
			if(f.exists())
