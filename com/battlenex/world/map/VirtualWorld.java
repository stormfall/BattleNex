package com.battlenex.world.map;
...
public class VirtualWorld {
	...
	public static final void init() {
		...
		com.battlenex.world.map.I.Iz(true);
	...
	public static final boolean I(int height, int currentX, int currentY,
		...
		if (currentX != futureX && futureY != currentY) {
			return com.battlenex.world.map.I.Iz(height, currentX, currentY, currentX,
					futureY, a)
					&& com.battlenex.world.map.I.Iz(height, currentX, currentY,
							futureX, currentY, a)
					&& com.battlenex.world.map.I.Iz(height, currentX, currentY,
							futureX, futureY, a);
		}
		return com.battlenex.world.map.I.Iz(height, currentX, currentY, futureX,
				futureY, a);
	}
