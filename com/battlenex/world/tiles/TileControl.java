package com.battlenex.world.tiles;

import com.battlenex.game.Entity;
import com.battlenex.world.Tile;
...
public class TileControl {
	...
	public static Tile[] getTiles(Entity entity) {
		...
		if (tiles.length == 1) 
			tiles[0] = generate(entity.getX(), entity.getY(), 0);
		else {
			for (int x = 0; x < size; x++) 
				for (int y = 0; y < size; y++) 
					tiles[tileCount++] = generate(entity.getX() + x, entity.getY() + y, 0);
		}	
		return tiles;
	}
